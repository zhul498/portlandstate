...
// Get category
const char* etsy::get_category() const
{
	return category;
}

// Create entry
int etsy::create_entry(char title_add[], char description_add[], char category_add[], char type_add[], float price_add, int quantity_add, int seller_id_add,
			char name_shop_add[], bool sold_flag_add)
{
	// Error check
